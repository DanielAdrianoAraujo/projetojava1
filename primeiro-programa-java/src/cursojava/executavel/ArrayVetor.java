 ...
 * 
 * 
 * // Array sempre deve ter a quantidade de posições definidas //double[] notas
 * = new double[4]; double[] notas = new double[Integer.parseInt(posicoes)];
 * 
 */

/*
 * notas[0] = 9.8; notas[1] = 10.1; notas[2] = 9.0; notas[3] = 9.5;
 */

/*
 * for (int pos = 0; pos < notas.length; pos++) { String valor =
 * JOptionPane.showInputDialog("Valor das Notas: " + (pos + 1)); notas[pos] =
